...
const Register = () => {
  const { register: registerUser, user, loading: authLoading } = useContext(AuthContext);
    ...
    <div className="flex-1 min-h-screen bg-navy-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl space-y-8 animate-slide-up">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-navy-400">Track and plan your job search today</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold uppercase tracking-wider text-navy-400">Full Name</label>
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 glass-input ${errors.name ? 'border-rose-500 focus:border-rose-500 focus:ring-rose-500' : ''}`}
                {...register('name', {
        ...
        <div className="text-center text-sm pt-2">
          <span className="text-navy-400">Already have an account? </span>
